...
INSTALLED_APPS = [
    ...
    'payments',                                      # Custom user payments app
    'acc_and_prof_management',                       # Custom user acc_and_prof_management app
    'delivery',                                      # Custom user delivery app
    'profiles',                                      # Custom user profiles app
    'search_and_discovery',                          # Custom user search_and_discovery app
    'partnerships',                                  # Custom user partnerships app
    'orders',                                        # Custom user orders app
    'notifications',                                 # Custom user notifications app
    'health_profiles',                               # Custom user health_profiles app
